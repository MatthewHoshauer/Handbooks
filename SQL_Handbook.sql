...
---- Create, Delete, Save / Backup ----------------------------------------------------

CREATE DATABASE database_name; -- Creates if admin priv
USE database_name;             -- Select
DROP DATABASE database_name;   -- Delete; be careful

BACKUP DATABASE database_name -- Creates full back up of existing database to path
TO DISK = 'filepath'  -- Ex: D:\backups\testDB.bak
WITH DIFFERENTIAL; -- Differential back up = only back up changes since last save
...
DROP TABLE Persons; -- Deletes existing table
TRUNCATE TABLE Persons; -- Deletes data inside table only
